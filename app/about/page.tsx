...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* About Us */}
      <section className="py-20 lg:py-32 min-h-screen flex items-center relative bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="img-box">
              <img
                ...
                className="max-lg:mx-auto object-cover rounded-2xl hover:-translate-y-2 transition-transform duration-300"
              />
            </div>
            <div className="lg:pl-16 flex items-center">
              <div className="data w-full">
                <h2 className="font-serif font-bold text-4xl lg:text-5xl text-[#0f0d1e] mb-10 max-lg:text-center relative">
                  About Us
                </h2>
                <p className="font-normal text-xl leading-8 text-[#6d6888] max-lg:text-center max-w-2xl mx-auto font-sans">
      ...
      {/* Premium Since */}
      <section className="py-20 lg:py-32 min-h-screen flex items-center relative bg-[#f8f7ff]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-16">
            <div className="lg:pr-16 flex items-center">
              <div className="data w-full">
                <img
                  ...
                  className="block lg:hidden mb-12 mx-auto object-cover rounded-2xl hover:-translate-y-2 transition-transform duration-300"
                />
                <h2 className="font-serif font-bold text-4xl lg:text-5xl text-[#0f0d1e] mb-10 max-lg:text-center">
            ...
            <div className="img-box">
              <img
                ...
                className="hidden lg:block object-cover rounded-2xl hover:-translate-y-2 transition-transform duration-300"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-8 xl:gap-10 lg:flex-row lg:justify-between">
      ...
      <section className="py-20 lg:py-32 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="font-serif text-4xl sm:text-5xl font-bold text-[#0f0d1e] mb-8">Our Leadership</h2>
            <div className="bg-[#f8f7ff] rounded-2xl p-10">
              <img
                ...
                className="w-36 h-36 rounded-full mx-auto object-cover border-4 border-[#FFB547] mb-8"
              />
              <h3 className="text-2xl font-bold font-serif text-[#0f0d1e] mb-3">Ibrahim Misheal Kallon</h3>
              <p className="text-lg text-[#FFB547] font-semibold mb-6 font-sans">Founder & CEO</p>
              <p className="text-[#6d6888] leading-relaxed font-sans">
      ...
      <section className="py-20 lg:py-32 bg-[#f8f7ff]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-4xl sm:text-5xl text-center font-bold text-[#0f0d1e] mb-8">Our Location</h2>
          <p className="text-lg text-[#6d6888] text-center max-w-3xl mx-auto mb-12 font-sans">
