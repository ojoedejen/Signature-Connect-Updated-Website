...
export default function AboutUsSection() {
  return (
    <section className="section bg-[#0f0d1e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-8 -right-8 bg-[#FFB547] rounded-2xl p-8 hidden sm:block">
          ...
          <div className="text-white">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-serif mb-8">
              About <span className="accent-text">Signature Connect</span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-6 sm:gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center p-6 glass-card rounded-xl">
                  <div className="text-3xl sm:text-4xl lg:text-5xl font-bold accent-text font-serif">
                    {stat.value}
                  </div>
